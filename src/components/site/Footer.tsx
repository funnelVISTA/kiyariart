    ...
    <footer className="relative mt-24 border-t border-border">
      <div className="container-page py-10 grid gap-8 md:grid-cols-3 md:items-start">
        ...
        <div className="text-center">
          <div className="text-[10px] uppercase tracking-[0.3em] text-gold mb-2">{t("footer.location").split("·")[0]?.trim() || "Studio"}</div>
          <div className="font-display text-lg">{t("footer.location")}</div>
        </div>
