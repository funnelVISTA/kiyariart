...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "art by KIYARI — Culturally guided, textured fine art" },
      { property: "og:description", content: "Original mixed-media paintings by Kiyari — culturally guided, textured art celebrating the strength, beauty, and excellence of Black essence." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "art by KIYARI — Culturally guided, textured fine art" },
      { name: "twitter:description", content: "Original mixed-media paintings by Kiyari — culturally guided, textured art celebrating the strength, beauty, and excellence of Black essence." },
